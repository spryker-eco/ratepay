...
{
    public const PROFILE_ID = 'RATEPAY:PROFILE_ID';
    public const SECURITY_CODE = 'RATEPAY:SECURITY_CODE';
    public const SNIPPET_ID = 'RATEPAY:SNIPPET_ID';
    public const SHOP_ID = 'RATEPAY:SHOP_ID';
    public const SYSTEM_ID = 'RATEPAY:SYSTEM_ID';
    public const RATEPAY_API_URL = 'RATEPAY:RATEPAY_API_URL';
